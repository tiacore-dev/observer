...
class Companies(Model):
    company_id = fields.CharField(max_length=255)
...
class UserCompanyRelations(Model):
    ...
    user = fields.ForeignKeyField(
        "models.Users", related_name="user_relations")
    company = fields.ForeignKeyField(
        "models.Companies", related_name="user_relations")
    role = fields.ForeignKeyField(
        "models.UserRoles", related_name="user_relations")
...
class AccountCompanyRelations(Model):
    ...
    company = fields.ForeignKeyField(
        "models.Companies", related_name="account_relations")
    account = fields.ForeignKeyField(
        "models.Accounts", related_name="account_relations")
...
class Chats(Model):
    ...
    default_prompt = fields.ForeignKeyField(
        "models.Prompts", related_name="chats", null=True)
    created_at = fields.DatetimeField(auto_now_add=True)
    company = fields.ForeignKeyField("models.Companies", related_name="chats")
...
class Bots(Model):
    ...
    def __repr__(self):
        return f"<Bots(bot_id={self.bot_id}, name='{self.bot_name}', active={self.is_active})>"
...
class BotChatRelations(Model):
    ...
    bot = fields.ForeignKeyField("models.Bots", related_name="bot_relations")
    chat = fields.ForeignKeyField("models.Chats", related_name="bot_relations")
...
class Message(Model):
    ...
    account = fields.ForeignKeyField(
        "models.Accounts", related_name="messages")
    ...
    def __repr__(self):
        return f"<Message(message_id={self.message_id}, chat={self.chat.chat_id}, account={self.account.account_id})>"
...
class TargetChats(Model):
    ...
    schedule = fields.ForeignKeyField(
        "models.ChatSchedules", related_name="target_chats")
    chat = fields.ForeignKeyField("models.Chats", related_name="target_chats")
...
class Prompts(Model):
    ...
    company = fields.ForeignKeyField(
        "models.Companies", related_name="prompts")
    created_at = fields.DatetimeField(auto_now_add=True)
