...
class AnalysisResult(Model):
    ...
    user = fields.ForeignKeyField(
        "diff_models.User", related_name="analysis_results", null=True)
    chat = fields.ForeignKeyField(
        "diff_models.Chat", related_name="analysis_results", null=True)
...
class Message(Model):
    ...
    user = fields.ForeignKeyField("diff_models.User", related_name="messages")
    # Идентификатор чата (64-битное число)
    chat = fields.ForeignKeyField("diff_models.Chat", related_name="messages")
